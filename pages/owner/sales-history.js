    ...
    <DashboardLayout title="Sales History" showBack={true} backUrl="/owner/main-menu">
      <PageContainer style={{ padding: '16px 20px' }}>
        <HistoryShell style={{ padding: 0 }}>
          ...
          {/* Segmented Tabs matching Table, Takeaway, Delivery, Completed, Cancelled - Centered */}
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', marginBottom: 18 }}>
